...
server.tool(
  ...
  TOOL_DESCRIPTION.trim(),
  {
    query: z
      .string()
      .describe(
        "Natural language question (e.g. 'What are the latest developments in quantum computing?')",
      ),
    model: z
